local copieditem = "se-space-solar-panel-2"
...
local newname = "kc-flat-lunar-panel-2"
local tint_value = {r = 190/255, g = 128/255, b = 1}
...
lunarpanelentity.next_upgrade = "kc-flat-lunar-panel-3"
...
for ai in pairs(lunarpanelrecipe.ingredients) do
  if lunarpanelrecipe.ingredients[ai].name == copieditemgraphics then lunarpanelrecipe.ingredients[ai].name = "kc-flat-lunar-panel" end
end
...
for ai in pairs(lunarpaneltechnology.prerequisites) do
  if lunarpaneltechnology.prerequisites[ai] == copieditemgraphics then lunarpaneltechnology.prerequisites[ai] = "kc-flat-lunar-panel" end
end
